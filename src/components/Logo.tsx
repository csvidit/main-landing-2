    ...
    <React.Fragment>
      ...
      >
        <motion.g transform="matrix(1,0,0,1,-1582.78,-1342.76)">
          <motion.g transform="matrix(15.8958,0,0,15.8958,-5911.28,-12543.4)" animate={{opacity: [0,1], transition: {ease: "easeInOut", delay: 0.2, duration: 0.2}}}>
            <motion.path
              ...
              style={{fill: "#a3e635"}}
              className="v-anim-1"
              animate={{scaleZ: [2, 0], transition: {ease: "easeInOut", delay: 0.2, duration: 0.2}}}
            ></motion.path>
          </motion.g>
          <motion.g transform="matrix(15.8958,0,0,15.8958,-5911.28,-12543.4)" animate={{opacity: [0,1], transition: {ease: "easeInOut", delay: 0.4, duration: 0.2}}}>
            <clipPath id="_clip1">
              <motion.rect
                x="527.867"
                y="940.188"
          ...
          <motion.g transform="matrix(15.8958,0,0,15.8958,-5911.28,-12543.4)" animate={{opacity: [0,1], transition: {ease: "easeInOut", delay: 0.6, duration: 0.2}}}>
            <clipPath id="_clip2">
              <motion.rect
                x="472.25"
                y="874.371"
